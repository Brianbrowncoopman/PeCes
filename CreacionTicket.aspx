    ...
    <table class="formulario-ticket" cellpadding="8" cellspacing="0">
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rfvTipoCliente" runat="server" ControlToValidate="ddlTipoCliente" InitialValue="" ErrorMessage="Seleccione tipo de cliente" ForeColor="Red" Display="Dynamic" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rfvRazonSocial" runat="server" ControlToValidate="txtRazonSocial" ErrorMessage="Razón Social es requerida para empresas" ForeColor="Red" Display="Dynamic" Enabled="false" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rfvRut" runat="server" ControlToValidate="txtRut" ErrorMessage="RUT es requerido" ForeColor="Red" Display="Dynamic" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txtEmail" ErrorMessage="Email es requerido" ForeColor="Red" Display="Dynamic" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rfvProducto" runat="server" ControlToValidate="txtProducto" ErrorMessage="Producto es requerido" ForeColor="Red" Display="Dynamic" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rfvDescripcion" runat="server" ControlToValidate="txtDescripcion" ErrorMessage="Descripción es requerida" ForeColor="Red" Display="Dynamic" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rfvEstado" runat="server" ControlToValidate="ddlEstado" InitialValue="" ErrorMessage="Seleccione estado del ticket" ForeColor="Red" Display="Dynamic" />
            </td>
        </tr>

        <tr>
            <td colspan="2" class="btn-centrado">
                <asp:Button ID="btnCrearTicket" runat="server" Text="Crear Ticket" OnClick="btnCrearTicket_Click" CssClass="btn-azulado" />
            </td>
        </tr>
    </table>
</asp:Content>
